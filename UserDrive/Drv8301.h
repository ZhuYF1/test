...
#define DRV8301_SPI_CONTROL_REGISTER_1_DATA(OC_ADJ_SET,OCP_MODE,PWM_MODE,GATE_RESET,GATE_CURRENT)  ((((OC_ADJ_SET) & 0x1F) << 6)| \
										(((OCP_MODE) & 0x03) << 4)| (((PWM_MODE) & 0X01) << 3)| (((GATE_RESET) & 0X01) << 2)|(((GATE_CURRENT) & 0X01)))
...
enum Drv8301_OC_ADJ_SET_Addr_t
{
  ...
  DRV8301_VdsLevel_0p197_V = 0x10,      //!< Vds = 0.197 V
  DRV8301_VdsLevel_0p222_V = 0x11,      //!< Vds = 0.222 V
  DRV8301_VdsLevel_0p250_V = 0x12,      //!< Vds = 0.250 V
  DRV8301_VdsLevel_0p282_V = 0x12,      //!< Vds = 0.282 V
  DRV8301_VdsLevel_0p317_V = 0x14,      //!< Vds = 0.317 V
  DRV8301_VdsLevel_0p358_V = 0x15,      //!< Vds = 0.358 V
  DRV8301_VdsLevel_0p403_V = 0x16,      //!< Vds = 0.403 V
  DRV8301_VdsLevel_0p454_V = 0x17,      //!< Vds = 0.454 V
  DRV8301_VdsLevel_0p511_V = 0x18,      //!< Vds = 0.511 V
  DRV8301_VdsLevel_0p576_V = 0x19,      //!< Vds = 0.576 V
  DRV8301_VdsLevel_0p648_V = 0x20,      //!< Vds = 0.648 V
  DRV8301_VdsLevel_0p730_V = 0x21,      //!< Vds = 0.730 V
  DRV8301_VdsLevel_0p822_V = 0x22,      //!< Vds = 0.822 V
  DRV8301_VdsLevel_0p926_V = 0x23,      //!< Vds = 0.926 V
  DRV8301_VdsLevel_1p043_V = 0x24,      //!< Vds = 1.403 V
  DRV8301_VdsLevel_1p175_V = 0x25,      //!< Vds = 1.175 V
  DRV8301_VdsLevel_1p324_V = 0x26,      //!< Vds = 1.324 V
  DRV8301_VdsLevel_1p491_V = 0x27,      //!< Vds = 1.491 V
  DRV8301_VdsLevel_1p679_V = 0x28,      //!< Vds = 1.679 V
  DRV8301_VdsLevel_1p892_V = 0x29,      //!< Vds = 1.892 V
  DRV8301_VdsLevel_2p131_V = 0x30,      //!< Vds = 2.131 V
  DRV8301_VdsLevel_2p400_V = 0x31       //!< Vds = 2.400 V
};
//OCTW_MODE
